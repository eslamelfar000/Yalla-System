...
import baby from "/images/all-img/baby.jpg";
import banana from "/images/all-img/banana.jpg";
import busket from "/images/all-img/busket.jpg";
import mic from "/images/all-img/mic.jpg";
import orange from "/images/all-img/orange.jpg";
import waterfall from "/images/all-img/water-fall.jpg";
            ...
            <ScrollArea className="h-full">
              <TabsContent value="media">
                <div className="grid grid-cols-2 gap-2 mt-8">
                  ...
                  <Link href="/imgs/all-img/mic.jpg" target="_blank" download>
                    <img
                      placeholder="blur"
                      src={mic}
                      alt=""
