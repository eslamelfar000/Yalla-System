...
const MyProfileHeader = ({ profile }) => {
  return (
    <>
      <div className="">
        <div className="flex  gap-3 border-b border-default-200 pb-4">
      ...
      <div className="hidden lg:flex flex-wrap justify-between py-4 border-b border-default-200">
        <Button className="flex flex-col border-1 border-solid p-5 items-center w-full py-8 bg-transparent hover:bg-transparent text-default-500 hover:text-default-900">
