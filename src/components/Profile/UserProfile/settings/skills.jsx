  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="flex flex-wrap gap-2 items-center">
          {
            ["HTML", "HTML 5", "CSS", "JavaScript", "React", "Nextjs", "Vue JS", "Nuxt JS", "PHP", "Tailwind"].map((item, index) => (
              <Badge
                key={`skill-${index}`}
                className="text-xs font-medium text-gray-500 bg-gray-200 flex items-center gap-2.5 cursor-pointer group "
              >
                {item}
        ...
        <Button
          className="mt-5 w-full bg-main cursor-pointer text-white font-semibold text-xs hover:bg-primary hover:text-primary-foreground"
        >
