      ...
      <div className="flex-none flex gap-2  items-center">
        ...
        {table.getPageOptions().map((page, pageIdx) => (
          <Button
            ...
            size="icon"
            className={cn("h-7 w-7 p-0 font-medium bg-default-100  text-default-600 rounded-md hover:bg-gray-200", {
              "bg-main text-primary-foreground hover:bg-main": table.getState().pagination.pageIndex === pageIdx,
            })}
          >
            {page + 1}
          </Button>
